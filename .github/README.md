...
[![GitHub Created At][create]][create-link] [![GitHub Issues][issues]][issues-link] [![Github Prs][prs]][pr-links] [![Github Commit][last-commit]][last-commit-link] [![Github Star][star]][star-link] [![Github Fork][fork]][fork-link] [![Carch Downloads][downloads]][downloads-link] [![Crates][crates]][crates-link] <!-- [![Telegram][telegram]][telegram-link] -->
...
<h4>For installation instructions, usage, commands, and more, check out the <a href="https://carch.chalisehari.com.np/"><em>official Carch documentation site</em></a> available in:
...
Make sure to read our [contributing guidelines](https://carch.chalisehari.com.np/project/contributing) before opening a pull request.
