...
install_terminal() {
    ...
    case $1 in
        "Alacritty")
            gum spin --spinner dot --title "Installing Alacritty..." -- sudo pacman -S alacritty --noconfirm &>/dev/null
            gum format "🎉 **Alacritty installed successfully!**"
            ;;
        "Kitty")
            gum spin --spinner dot --title "Installing Kitty..." -- sudo pacman -S kitty --noconfirm &>/dev/null
            gum format "🎉 **Kitty installed successfully!**"
            ;;
        "GNOME Terminal")
            gum spin --spinner dot --title "Installing GNOME Terminal..." -- sudo pacman -S gnome-terminal --noconfirm &>/dev/null
            gum format "🎉 **GNOME Terminal installed successfully!**"
            ;;
        "Konsole")
            gum spin --spinner dot --title "Installing Konsole..." -- sudo pacman -S konsole --noconfirm &>/dev/null
            gum format "🎉 **Konsole installed successfully!**"
            ;;
        "Xfce Terminal")
            gum spin --spinner dot --title "Installing Xfce Terminal..." -- sudo pacman -S xfce4-terminal --noconfirm &>/dev/null
            gum format "🎉 **Xfce Terminal installed successfully!**"
            ;;
        "LXTerminal")
            gum spin --spinner dot --title "Installing LXTerminal..." -- sudo pacman -S lxterminal --noconfirm &>/dev/null
            gum format "🎉 **LXTerminal installed successfully!**"
            ;;
        "MATE Terminal")
            gum spin --spinner dot --title "Installing MATE Terminal..." -- sudo pacman -S mate-terminal --noconfirm &>/dev/null
            gum format "🎉 **MATE Terminal installed successfully!**"
            ;;
        "xterm")
            gum spin --spinner dot --title "Installing xterm..." -- sudo pacman -S xterm --noconfirm &>/dev/null
            gum format "🎉 **xterm installed successfully!**"
            ;;
        "urxvt (rxvt-unicode)")
            gum spin --spinner dot --title "Installing urxvt (rxvt-unicode)..." -- sudo pacman -S rxvt-unicode --noconfirm &>/dev/null
            gum format "🎉 **urxvt (rxvt-unicode) installed successfully!**"
            ;;
        "Tilix")
            gum spin --spinner dot --title "Installing Tilix..." -- sudo pacman -S tilix --noconfirm &>/dev/null
            gum format "🎉 **Tilix installed successfully!**"
            ;;
        "Terminator")
            gum spin --spinner dot --title "Installing Terminator..." -- sudo pacman -S terminator --noconfirm &>/dev/null
            gum format "🎉 **Terminator installed successfully!**"
            ;;
        "Guake")
            gum spin --spinner dot --title "Installing Guake..." -- sudo pacman -S guake --noconfirm &>/dev/null
            gum format "🎉 **Guake installed successfully!**"
            ;;
        "Yakuake")
            gum spin --spinner dot --title "Installing Yakuake..." -- sudo pacman -S yakuake --noconfirm &>/dev/null
            gum format "🎉 **Yakuake installed successfully!**"
            ;;
        "Tilda")
            gum spin --spinner dot --title "Installing Tilda..." -- sudo pacman -S tilda --noconfirm &>/dev/null
            gum format "🎉 **Tilda installed successfully!**"
            ;;
        "Cool Retro Term")
            gum spin --spinner dot --title "Installing Cool Retro Term..." -- sudo pacman -S cool-retro-term --noconfirm &>/dev/null
            gum format "🎉 **Cool Retro Term installed successfully!**"
            ;;
        "Sakura")
            gum spin --spinner dot --title "Installing Sakura..." -- sudo pacman -S sakura --noconfirm &>/dev/null
            gum format "🎉 **Sakura installed successfully!**"
            ;;
        "st (Simple Terminal)")
            gum spin --spinner dot --title "Installing st (Simple Terminal)..." -- paru -S st --noconfirm &>/dev/null
            gum format "🎉 **st (Simple Terminal) installed successfully!**"
            ;;
        "Eterm")
            gum spin --spinner dot --title "Installing Eterm..." -- paru -S eterm --noconfirm &>/dev/null
            gum format "🎉 **Eterm installed successfully!**"
            ;;
        "WezTerm")
            gum spin --spinner dot --title "Installing WezTerm..." -- sudo pacman -S wezterm --noconfirm &>/dev/null
            gum format "🎉 **WezTerm installed successfully!**"
            ;;
        "Deepin Terminal")
            gum spin --spinner dot --title "Installing Deepin Terminal..." -- sudo pacman -S deepin-terminal --noconfirm &>/dev/null
            gum format "🎉 **Deepin Terminal installed successfully!**"
            ;;
        "Zellij")
            gum spin --spinner dot --title "Installing Zellij..." -- sudo pacman -S zellij --noconfirm &>/dev/null
            gum format "🎉 **Zellij installed successfully!**"
            ;;
        "Termite")
            gum spin --spinner dot --title "Installing Termite..." -- paru -S termite --noconfirm &>/dev/null
            gum format "🎉 **Termite installed successfully!**"
            ;;
        "fbterm")
            gum spin --spinner dot --title "Installing fbterm..." -- paru -S fbterm --noconfirm &>/dev/null
...
install_terminals() {
    echo -e "Select a terminal to install:"
    echo -e "1) Alacritty"
    echo -e "2) Kitty"
