...
function __fish_carch_global_optspecs
	string join \n log v/version c/catppuccin-mocha d/dracula g/gruvbox n/nord r/rose-pine h/help
end
...
complete -c carch -n "__fish_carch_needs_command" -l log -d 'Enable logging, output is on ~/.config/carch/carch.log'
...
complete -c carch -n "__fish_carch_needs_command" -f -a "completions" -d 'Generate completions for a shell'
complete -c carch -n "__fish_carch_needs_command" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c carch -n "__fish_carch_using_subcommand check-update" -l log -d 'Enable logging, output is on ~/.config/carch/carch.log'
...
complete -c carch -n "__fish_carch_using_subcommand update" -l log -d 'Enable logging, output is on ~/.config/carch/carch.log'
...
complete -c carch -n "__fish_carch_using_subcommand uninstall" -l log -d 'Enable logging, output is on ~/.config/carch/carch.log'
...
complete -c carch -n "__fish_carch_using_subcommand completions" -l log -d 'Enable logging, output is on ~/.config/carch/carch.log'
complete -c carch -n "__fish_carch_using_subcommand completions" -s c -l catppuccin-mocha -d 'Set theme to Catppuccin Mocha'
complete -c carch -n "__fish_carch_using_subcommand completions" -s d -l dracula -d 'Set theme to Dracula'
complete -c carch -n "__fish_carch_using_subcommand completions" -s g -l gruvbox -d 'Set theme to Gruvbox'
complete -c carch -n "__fish_carch_using_subcommand completions" -s n -l nord -d 'Set theme to Nord'
complete -c carch -n "__fish_carch_using_subcommand completions" -s r -l rose-pine -d 'Set theme to Rosé Pine'
complete -c carch -n "__fish_carch_using_subcommand completions" -s h -l help -d 'Print help'
complete -c carch -n "__fish_carch_using_subcommand help; and not __fish_seen_subcommand_from check-update update uninstall completions help" -f -a "check-update" -d 'Check for updates'
complete -c carch -n "__fish_carch_using_subcommand help; and not __fish_seen_subcommand_from check-update update uninstall completions help" -f -a "update" -d 'Update the application'
complete -c carch -n "__fish_carch_using_subcommand help; and not __fish_seen_subcommand_from check-update update uninstall completions help" -f -a "uninstall" -d 'Uninstall the application'
complete -c carch -n "__fish_carch_using_subcommand help; and not __fish_seen_subcommand_from check-update update uninstall completions help" -f -a "completions" -d 'Generate completions for a shell'
complete -c carch -n "__fish_carch_using_subcommand help; and not __fish_seen_subcommand_from check-update update uninstall completions help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'